...
CanClass        Can(USB0, 9600, 'N', 8, 1, "192.168.88.100", 4007, CanClass::RTU);
...
//    Manager.addTaskEvery("00:00:2", mercury_thread, "MERCURY");
...
//    Manager.addTaskAtAndEvery("10:00", "00:00:01", sendToServer/*, "SENDING"*/);
